...
var configs = {
	...
	regTitle: __fmts({
		...
		/****** 非常规标题 ******/
		't1': [
			'[引楔]子|引言|序篇?章|自?序[言幕]?|[题題][注记註記跋]|[题題开][卷篇头][诗词语詩詞語]|文案|卷[首后後][语語]|(?:作者)?前言|[全本下][{$c.0}{$c.1}](?:[简簡]介|介[绍紹]|[预預]告)|(?:作品|作者|人物|内容)?(?:[简簡]介|介[绍紹]|[预預]告|自介)|篇[后後]|[后後][记话記話序]|尾[声记聲記]|(?:完本|作者)感言|附[录錄]|作者的[话話]|正文',
			'{$tf}[{$c.0}{$c.1}]',
			'{$tf}[{$c.2}]',

...
"$1"+a[2]).replace(/"/g,a[3]).replace(new RegExp("^([\u3000]*)"+a[3],"gm"),"$1"+a[2]).replace(new RegExp(a[2]+"$","gm"),a[3]).replace(new RegExp("\uff1a"+a[3],"g"),"\uff1a"+a[2])},replaceTitle:function(a,d,b,e){var h=configs.Divide,g=a||"\n\n",l=d||"",k=b||!1;a=this;e&&(configs.regSeparator=configs.regSeparatorNull,configs.regStrictEnd=configs.regEnd);e=configs.regTitle;d=configs.regSeparator;b=configs.regSeparatorNull;var m=new RegExp("^"+d,"g"),n=new RegExp("^"+d+"$","g");k&&(a=a.replace(new RegExp(configs.regStart+
configs.Separator,"gm"),function(a){return doCenter(a,"","",k)}));var f=["^"+configs.regStart,"","(?:"+b+")","("+configs.regEnd+"|$)","$"];f[1]="("+e.t1.join("|")+")";a=a.replace(new RegExp(f.join(""),"gm"),function(a,d,b){if(b.match(/^[\uff01\uff1f\u3002]{1,3}$/g))return a;b=b.replace(m,"").replace(/[\u3010\u3011]/g,"").replace(n,"");0<b.length&&(b=h+b);return doCenter(d+b,g,l,k)});a=a.replace(new RegExp("("+e.t1[0]+")"+h+"(\uff08?[0-9\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]{1,2}\uff09?)",
"g"),"$1$2");a=a.replace(new RegExp(["^"+configs.regStart,"[\u3010]?"+e.t2+"[\u3011]?","("+b+")","[\u3010]?("+configs.regEnd+"|$)[\u3011]?","$"].join(""),"gm"),function(a){return a.replace(/[\u3010\u3011]/g,"")});f[1]=e.t2;a=a.replace(new RegExp(f.join(""),"gm"),function(a,d,b,e){if(a.match(configs.regSkipTitle)&&!e.match(configs.regSeparatorCheck)&&e.match(/[\uff01\uff1f\u3002\u2026]{1,3}$/g)||b.match(/^[\-\u2014]{1,4}/g)||!e.match(configs.regSeparatorCheck)&&e.match(/[\uff0c]/g)&&e.match(/[\uff01\uff1f\u3002\u2026]{1,3}$/g))return a;
e=e.replace(m,"").replace(/([\u4E00-\u9FA5])[ ]+([\u4E00-\u9FA5])/g,"$1\uff0c$2").replace(/([\w]+)[ ]{1,4}([\w]+)/g,"$1 $2").replace(n,"");0<e.length&&(e=h+e);b=b.replace(/[ ]*/g,"");return doCenter("\u7b2c"+b+e,g,l,k)});f[1]=e.t5;f[2]="";a=a.replace(new RegExp(f.join(""),"gm"),function(a,d,b){b=b.replace(m,"").replace(/[\u3010\u3011]/g,"").replace(n,"");return doCenter(d+b,g,l,k)});if(k)return a;f[1]=e.t3;f[2]="(?:"+b+")";a=a.replace(new RegExp(f.join(""),"gm"),function(a,d,b,e){e=e.replace(m,"").replace(/[\u3010\u3011]/g,
"").replace(n,"");0<e.length&&(e=h+e);return g+"\u7b2c"+b+d+e+l});f[1]=e.t4;f[2]="("+d+"|";f[3]=d+configs.regStrictEnd+"|$)";var p=configs.regSkipTitle1;return a=a.replace(new RegExp(f.join(""),"gm"),function(a,d,b){for(var e=0;e<p.length;e++)if(a.match(p[e]))return a;if(b.match(/^[\uff01\uff1f\u3002\u2026]/))return a;b=b.replace(m,"").replace(/[\u3010\u3011]/g,"").replace(n,"");0<b.length&&(b=h+b);return g+"\u7b2c"+d+"\u7ae0"+b+l})}});
var doCenter=function(a,d,b,e){d=d||"\n";b=b||"";e=e||!1;var h=2*configs.Linenum;if(e){a=a.trim();var g=a.len();e&&h>g&&(a="\u3000".times(parseInt((h-g)/4,10))+a)}return d+a+b};

...
0<=(d-=cl))h+=String.fromCharCode(c);else break;return h},trimSpace:function(a){return this.replace(configs.trim,a||"")},replaceInit:function(){return this.replace(/(\r\n|\n\r|\r|\n)/gm,"\n").replace(configs.Space," ").trimSpace("\n").replace(/$/g,"\n").replace(/([a-zA-Z])(['`\uff07\u2018\u2019\u300e\u300f])([a-zA-Z])/g,"$1'$3").replace(/^\u300d/gm,"\u300c").replace(/^\u300f/gm,"\u300e").replace(/^\u201d/gm,"\u201c").replace(/^\u2019/gm,"\u2018").replace(/\u300c$/gm,"\u300d").replace(/\u300e$/gm,

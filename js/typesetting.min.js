...
b,e){var k=configs.Divide,h=a||"\n\n",m=d||"",l=b||!1;a=this;e&&(configs.regSeparator=configs.regSeparatorNull,configs.regStrictEnd=configs.regEnd);e=configs.regTitle;var g=configs.regSeparator;d=configs.regSeparatorNull;l&&(a=a.replace(new RegExp(configs.regStart+configs.Separator,"gm"),function(a){return doCenter(a,"","",l)}));b=["^"+configs.regStart,"","(?:"+d+")","("+configs.regEnd+"|$)","$"];b[1]="("+e.t1.join("|")+")";a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d){if(d.match(/^[\uff01\uff1f\u3002]{1,3}$/g))return a;
d=d.replace(new RegExp("^"+g,"g"),"").replace(/[\u3010](.*)[\u3011]$/g,"$1").replace(new RegExp("^"+g+"$","g"),"");0<d.length&&(d=k+d);return doCenter(b+d,h,m,l)});a=a.replace(new RegExp("("+e.t1[0]+")"+k+"(\uff08?[0-9\u96f6\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]{1,2}\uff09?)","g"),"$1$2");a=a.replace(new RegExp(["^"+configs.regStart,"[\u3010]?"+e.t2+"[\u3011]?","("+d+")","[\u3010]?("+configs.regEnd+"|$)[\u3011]?","$"].join(""),"gm"),function(a){return a.replace(/[\u3010\u3011]/g,
"")});b[1]=e.t2;a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d,f){if(a.match(configs.regSkipTitle)&&!f.match(configs.regSeparatorCheck)&&f.match(/[\uff01\uff1f\u3002\u2026]{1,3}$/g)||d.match(/^[\-\u2014]/g)||0===f.length&&d.match(/[\uff01\uff1f\u3002\u2026]{1,3}$/g))return a;f=f.replace(new RegExp("^"+g,"g"),"").replace(/([\u4E00-\u9FA5])[ ]+([\u4E00-\u9FA5])/g,"$1\uff0c$2").replace(/([\w]+)[ ]{1,4}([\w]+)/g,"$1 $2").replace(new RegExp("^"+g+"$","g"),"");0<f.length&&(f=k+f);d=d.replace(/[ ]*/g,
"");return doCenter("\u7b2c"+d+f,h,m,l)});b[1]=e.t5;b[2]="";a=a.replace(new RegExp(b.join(""),"gm"),function(a,d,b){b=b.replace(new RegExp("^"+g,"g"),"").replace(/[\u3010](.*)[\u3011]$/g,"$1").replace(new RegExp("^"+g+"|"+g+"$","g"),"");return doCenter(d+b,h,m,l)});if(l)return a;b[1]=e.t3;b[2]="(?:"+d+")";a=a.replace(new RegExp(b.join(""),"gm"),function(a,d,b,f){f=f.replace("^"+new RegExp(g,"g"),"").replace(/[\u3010](.*)[\u3011]$/g,"$1").replace(new RegExp("^"+g+"$","g"),"");0<f.length&&(f=k+f);return h+
"\u7b2c"+b+d+f+m});b[1]=e.t4;b[2]="("+g+"|";b[3]=g+configs.regStrictEnd+"|$)";return a=a.replace(new RegExp(b.join(""),"gm"),function(a,d,b){var f=/^[\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]{1,4}[\u5e74\u6708\u65e5\u70b9\u65f6\u5206\u79d2\u9ede\u6642]([\d\uff10-\uff19\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d\u5341]|$)/g,e=/^[\d\uff10-\uff19]{1,2}[:\uff1a][\d\uff10-\uff19]{1,2}[:\uff1a][\d\uff10-\uff19]{1,2}/g,l=/^[\d\uff10-\uff19]{1,6}[%\uff05\u2030\u2103\u00b0]$/g,
n=/^[\d\uff10-\uff19]{1,2}[:\uff1a][\d\uff10-\uff19]{1,2}/g;if(/^([\d\uff10-\uff19]{2,4})[\.\-\/\u3002\u2014][\d\uff10-\uff19]{1,2}[\.\-\/\u3002\u2014][\d\uff10-\uff19]{1,2}/g.test(a)||f.test(a)||e.test(a)||l.test(a)||n.test(a))return a;b=b.replace(new RegExp("^"+g,"g"),"").replace(/[\u3010](.*)[\u3011]$/g,"$1").replace(new RegExp("^"+g+"$","g"),"");0<b.length&&(b=k+b);return h+"\u7b2c"+d+"\u7ae0"+b+m})}});

...
"\u3010\u6ce8$1\u3011").replace(/([^\d\.])\b(\d{1,2})$/,"$1\uff08$2\uff09");return 0<a.length&&b?configs.Divide+a:a},h=function(a,b){return configs.regSkipTitle[b||"t0"].test(a)};a=this.__Chapter(f.t0,"^{$f}({$t0})(?:{$s}|$)$","",function(a,b){return b.setAlign(e,g,c)}).__Chapter(f.t1.join("|"),"^{$f}({$t1})(?:{$sn})({$e}|$)$","|",function(a,b,d){return h(a)||/^[!\?\uff01\uff1f\u3002]{1,3}$/.test(d)||h(a,"t1")?a:(b+k(d)).setAlign(e,g,c)}).__Chapter(f.t2,"^{$f}{$t2}({$sn})({$e}|$)$","",function(a,
b,f,l){if(h(a)||/^[\-\u2014]{2,4}/.test(b)||!d&&/^[\uff01\uff1f\u3002\u2026]{1,3}$/.test(l)||!f&&(!d&&/[\uff0c]|[\uff01\uff1f\u3002\u2026\u2019\u201d\u300f\u300d]{1,3}$/.test(l)||h(a,"t2")))return a;"{$n4}[{$c}]".fmtReg(strChapter).test(b)||(b="\u7b2c"+b.replace(/(^\u7b2c+| )/g,"").__convertDBCNumber());return(b+k(l)).setAlign(e,g,c)}).__Chapter(f.t3,"^{$f}{$t3}({$e}|$)$","",function(a,b,d){if(h(a))return a;b=b.__convertDBCNumber();return(b+k(d,"no")).setAlign(e,g,c)});if("center"===c||"break"===
c)return a;var m=configs.regSkipTitle.t6;return a.__Chapter(f.t4,"^{$f}{$t4}{$sn}({$e}|$)$","",function(a,b,c,d){return(e+"\u7b2c"+c+b+k(d)+g).__convertDBCNumber()}).__Chapter(f.t5,"^{$f}{$t5}{$s}({$e}|$)$","",function(a,b,c){return(e+"\u7b2c"+b+"\u7ae0"+k(c)+g).__convertDBCNumber()}).__Chapter(f.t6,"^{$f}{$t6}({$s}|{$s}{$e}|$)$","",function(a,b,c){if(h(a)||h(a,"t2")||/^[\uff01\uff1f\u3002]{1,3}$/.test(c)||/[\u3002]/.test(a))return a;if(/^[\d\uff10-\uff19]+/.test(b)){if(/[\uff01\uff1f\u3002]$/.test(c))return a}else if(/[\uff01\uff1f\u3002\u2026\u2019\u201d\u300f\u300d]$/.test(c))return a;
for(var d=0;d<m.length;d++)if(m[d].test(a))return a;return(e+"\u7b2c"+b+"\u7ae0"+k(c)+g).__convertDBCNumber()})},replaceTitleError:function(){var a=this,b="(^{$f}\u7b2c{$n1}[{$c.2}](?:[\uff1a].{0,40}|$)$\\n+|^{$f}{$n1}(?:[\uff1a\u3001\u3002.,].{0,40}|$)$\\n+){2,}".chapReg();if(b.test(a)){var c="^{$f}\u7b2c({$n1})[{$c.2}]\uff1a".chapReg();var d="^{$f}\u7b2c({$n1})[{$c.2}]$".chapReg();var e="^{$f}({$n1})[\uff1a\u3001\u3002.,]".chapReg();a=a.replace(b,function(a){return a.replace(c,"$1\u3001").replace(d,
"$1").replace(e,"$1\u3001").replace(/^0{1,4}/gm,"").replace(/\n\n+/gm,"\n")}).replace("\\n\\n({$n1}\u3001?)".chapReg(),"$1")}b="(^{$f}(\u7b2c{$n3}[{$c.2}])(?:[\uff1a].{0,40}|$)$\\n+|^{$f}{$n3}(?:[\uff1a\u3001\u3002.,].{0,40}|$)$\\n+){2,}".chapReg();b.test(a)&&(c="^{$f}\u7b2c({$n3})[{$c.2}]\uff1a".chapReg(),d="^{$f}\u7b2c({$n3})[{$c.2}]$".chapReg(),e="^{$f}({$n3})[\uff1a\u3001\u3002.,]".chapReg(),a=a.replace(b,function(a){return a.replace(c,"$1\u3001").replace(d,"$1").replace(e,"$1").replace(/\n\n+/gm,

...
!0).replace(/([a-zA-Z]+)['`\uff07\u2018\u2019\u300e\u300f]([a-zA-Z]+)/g,function(a,b,c){return b.toUpper(/\b[a-z]/g,!0)+"'"+c.toLowerCase()}).replace(/([0-9a-zA-Z]+)[\u3002\.]([0-9a-zA-Z\u2014\-_]+)[\u3002\.](com|net|org|gov)/gi,function(a){return a.replace(/\u3002/g,".").toLowerCase()}),b=configs.pWord.split("|"),c=0;c<b.length;c++)a=a.replace(new RegExp("\\b("+b[c]+")([0-9]*)\\b","gi"),b[c]+"$2");return a},convertNumberLetter:function(a){return this.convertLetter(a).convertNumber(a).replaces(configs.nwSymbol)},
...
"\uff0a".times(35)).replace(/@@@@/g,configs.Separator)},replaceQuotes:function(a,b){a=("cn"!==a?"\u2018\u2019\u201c\u201d":"\u300e\u300f\u300c\u300d").split("");b=b||!1;var c=this.replace(/([a-zA-z])(['`\uff07\u2018\u2019\u300e\u300f])([a-zA-z])/g,"$1\u203b@\u203b$3");b||(c=c.replace(/[\u2018\u2019\u300e\u300f]/g,"'").replace(/[\u201c\u201d\u300c\u300d]/g,'"'));return c.replace(/[`\uff07]/g,"'").replace(/[\u301d\u301e\uff3b\uff3d\uff02\u2033\uff62\uff63]/g,'"').replace(/'([^'\r\n]+)'/g,a[0]+"$1"+
a[1]).replace(/^([\u3000]+)'/gm,"$1"+a[0]).replace(/'/g,a[1]).replace(new RegExp("^([\u3000]*)"+a[1],"gm"),"$1"+a[0]).replace(new RegExp(a[0]+"$","gm"),a[1]).replace(/\u203b@\u203b/g,"'").replace(/"([^"\r\n]+)"/g,a[2]+"$1"+a[3]).replace(/^([\u3000]+)"/gm,"$1"+a[2]).replace(/"/g,a[3]).replace(new RegExp("^([\u3000]*)"+a[3],"gm"),"$1"+a[2]).replace(new RegExp(a[2]+"$","gm"),a[3]).replace(new RegExp("\uff1a"+a[3],"g"),"\uff1a"+a[2])},setAlign:function(a,b,c){var d=2*configs.Linenum,e=this.trim(),f=e.len();
c=c||"left";a=null!=a?a:"";b=null!=b?b:"";"center"===c?(c=0===f%4?" ":"",d>f&&(e="\u3000".times(parseInt((d-f)/4,10))+c+e)):"right"===c?(c=0===f%2?"":" ",d>f&&(e="\u3000".times(parseInt((d-f)/2,10))+c+e)):e=e.space();return a+e+b},replaceBorder:function(a){var b=configs.regTitle;b.t=a;b.b=configs.regTitleBorder;a="^{$f}[{$b.0}]?({$t})[{$b.1}]?({$s})?[{$b.0}]?({$e}|$)[{$b.1}]?$".fmt(b);return this.replace(a.getReg("gm"),function(a){return a.replace(("["+b.b.join("")+"]").getReg("gm"),"")})},replaceTitle:function(a,
b,c,d){var e=a||"\n\n",f=b||"";a=this;var g=configs.regTitle,l=("^"+g.s).getReg("g"),n=("^"+g.s+"$").getReg("g");!0===d&&(g.s=g.sn,g.es=g.e);var h=function(a,b){if(0==a.length)return"";b=b?!1:!0;a=a.replace(/[ ]{1,}/g," ").replace(l,"").replace(/([\u4E00-\u9FA5]{2,})[ ]([\u4E00-\u9FA5]{2,})/g,"$1\uff0c$2").replace(/([\u4E00-\u9FA5])[ ]([\u4E00-\u9FA5])/g,"$1$2").replace(/(\w+)[ ]{1,4}(\w+)/g,"$1 $2").replace(n,"");return 0<a.length&&b?configs.Divide+a:a};d=function(a,b){return new RegExp(a.fmt(g,
b),"gim")};b=d("^{$f}({$t1})(?:{$sn})({$e}|$)$","|");a=a.replaceBorder(g.t1.join("|")).replace(b,function(a,b,k){return k.match(/^[\uff01\uff1f\u3002]{1,3}$/g)?a:(b+h(k)).setAlign(e,f,c)});b=d("^{$f}{$t2}({$sn})({$e}|$)$");a=a.replaceBorder(g.t2).replace(b,function(a,b,k,d){return k.match(/^[\-\u2014]{1,4}/g)||d.match(/^[\uff01\uff1f\u3002\u2026]{1,3}$/g)||!k.match(l)&&d.match(/[\uff0c]|[\uff01\uff1f\u3002\u2026]{1,3}$/g)||a.match(configs.regSkipTitle)&&!k.match(l)&&d.match(/[\uff01\uff1f\u3002\u2026]{1,3}$/g)?
a:("\u7b2c"+b.replace(/(^[\u7b2c]+| )/g,"")+h(d)).setAlign(e,f,c)});b=d("^{$f}{$t5}({$e}|$)$");a=a.replaceBorder(g.t5).replace(b,function(a,b,d){return(b+h(d,"no")).setAlign(e,f,c)});if("center"===c)return a;b=d("^{$f}{$t3}(?:{$sn})({$e}|$)$");a=a.replaceBorder(g.t3).replace(b,function(a,b,c,d){return e+"\u7b2c"+c+b+h(d)+f});b=d("^{$f}{$t6}(?:{$s})({$e}|$)$");a=a.replaceBorder(g.t6).replace(b,function(a,b,c){return e+"\u7b2c"+b+"\u7ae0"+h(c)+f});var m=configs.regSkipTitle1;b=d("^{$f}{$t4}({$s}|{$s}{$e}|$)$");
return a=a.replaceBorder(g.t4).replace(b,function(a,b,c){if(c.match(/^[\uff01\uff1f\u3002\u2026]{1,3}$/g)||!c.match(l)&&c.match(/[\uff01\uff1f\u3002\u2026]$/g))return a;for(var d=0;d<m.length;d++)if(a.match(m[d]))return a;return e+"\u7b2c"+b+"\u7ae0"+h(c)+f})}});

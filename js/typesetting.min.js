...
function(a,b){return(b.match(/[\u2026\uff01\uff1f\u3002!\?\.]$/g)||b.match(/[\uff0c\uff1a\uff1b\uff06,:;&']/g))&&b.match(/\w/g)?a.toUpper(/[\uff0c, ][A-Z]/g,!1).replaces(configs.halfSymbol).toUpper(/[\.\?!:&][ ]?[a-z]/g,!0):a}).replace(/^([\w \uff01\uff08\uff09\uff0c\uff1a\uff1b\uff1f\u2013\u2026\u3002\uff06\uff20\uff03!\(\),:;\?\-\.&@#']{2,})$/gm,function(a){return a.toUpper(/[\uff0c ][A-Z]/g,!1)}).replace(/\b([A-Za-z\d]+)\b/g,function(a){return a.match(/\d/)?a.toUpperCase():a}).toUpper(/([a-zA-Z]+[\-\u2014~\uff5e]\d|\d[\-\u2014~\uff5e][a-zA-Z]+)/g,
!0).toUpper(/\b(a{2,}|b{2,}|c{2,}|d{2,}|e{2,}|f{2,}|g{2,}|h{2,}|i{2,}|j{2,}|k{2,}|l{2,}|m{2,}|n{2,}|o{2,}|p{2,}|q{2,}|r{2,}|s{2,}|t{2,}|u{2,}|v{2,}|w{2,}|x{2,}|y{2,}|z{2,})\b/gi,!0).replace(/([a-zA-Z]+)['`\uff07\u2018\u2019\u300e\u300f]([a-zA-Z]+)/g,function(a,b,d){return b.toUpper(/\b[a-z]/g,!0)+"'"+d.toLowerCase()}).replace(/([0-9a-zA-Z]+)[\u3002\.]([0-9a-zA-Z\u2014\-_]+)[\u3002\.](com|net|org|gov)/gi,function(a){return a.replace(/\u3002/g,".").toLowerCase()}),b=configs.pWord.split("|"),d=0;d<b.length;d++)a=
a.replace(new RegExp("\\b("+b[d]+")([0-9]*)\\b","gi"),b[d]+"$2");return a},convertNumberLetter:function(a){return this.convertLetter(a).convertNumber(a).replaces(configs.nwSymbol)},convertDBCNumber:function(){return this.replace(/[\uFF10-\uFF19]/g,function(a){return String.fromCharCode(a.charCodeAt(0)-65248)})},convertNumber:function(a){return 1===a?this.replace(/[\u0030-\u0039]/g,function(a){return String.fromCharCode(a.charCodeAt(0)+65248)}).replace(new RegExp(configs.regSBCNumberTitle,"g"),function(a){return a.convertDBCNumber()}):
this.convertDBCNumber()},convertLetter:function(a){var b=this.replace(/([\uFF41-\uFF5A])([\uFF21-\uFF3A])/g,"$1 $2");return 1===a?b.replace(/[a-zA-Z]/g,function(a){return String.fromCharCode(a.charCodeAt(0)+65248)}):b.replace(/[\uFF41-\uFF5A\uFF21-\uFF3A]/g,function(a){return String.fromCharCode(a.charCodeAt(0)-65248)})},converUnicode:function(){return this.replace(/\\u?([0-9a-f]{4})/gi,function(a){return unescape(a.replace(/\\u?/gi,"%u"))}).replace(/([\uff06&]#(\d+)[;\uff1b])/gi,function(a){return String.fromCharCode(a.replace(/[\uff06&#;\uff1b]/g,
""))})},converHtmlEntity:function(){return this.replace(configs.regHtmlEntity,function(a,b){return configs.sHtmlEntity[b]||a})},convertVariant:function(){return this.replaces(configs.sVariant)},convertSerialNumber:function(){return this.replaces(configs.sSerialNumber)},convertPunctuation:function(){return this.replaces(configs.punSymbol).replaces(configs.nwSymbol)},replaceSpace:function(){return this.replace(/[\t]+(?=[\u4e00-\u9fa0])/g,"\n").replace(/[ ]+/g," ").replace(/[ ]+(?=[\u4e00-\u9fa0\u00b7\uff01\uff08\uff09\uff0c\uff0e\uff1a\uff1b\uff1f\u2013\u2014\u2018\u2019\u201c\u201d\u2026\u3001\u3002\u3008-\u3011\u3014\u3015\uffe0-\uffe5\uff06\/\\\+\-'])/g,

...
65248)}):b.replace(/[\uff21-\uff3a\uff41-\uff5a]/g,function(a){return String.fromCharCode(a.charCodeAt(0)-65248)})},convertUnicode:function(){return this.replace(/\\u?([\da-f]{4})/gi,function(a){return unescape(a.replace(/\\u?/gi,"%u"))}).replace(/[\uff06&]#(\d+)[;\uff1b]/g,function(a,b){return String.fromCharCode(b)}).replace(/([%\uff05][\da-f]{2})+/gi,function(a){try{a=decodeURIComponent(a.replace(/\uff05/g,"%"))}catch(b){}return a})},convertHtmlEntity:function(){return this.replace(configs.regHtmlEntity,
...
g)/4,10))+c+e)):"right"===c?(c=0===g%2?"":" ",d>g&&(e="\u3000".times(parseInt((d-g)/2,10))+c+e)):e=e.space();return a+e+b},replaceBorder:function(a){var b=configs.regTitle;b.t=a;b.b=configs.regTitleBorder;a="^{$f}[{$b.0}]?({$t})[{$b.1}]?({$sn})[{$b.0}]?({$e}|$)[{$b.1}]?$".fmtReg(b,"gm");var c=("["+b.b.join("")+"]").getReg();return this.replace(a,function(a){return a.replace(c," ")})},replaceTitle:function(a,b,c,d){var e=a||"\n\n",g=b||"";a=this;var f=configs.regTitle,l=("^"+f.s).getReg(),n=("^"+f.s+
"$").getReg();d&&(f.s=f.sn,f.es=f.e);var h=function(a,b){if(0===a.length)return"";b=b?!1:!0;a=a.replace(/[ ]+/g," ").replace(l,"").replace(/[ ](?=[\u4E00-\u9FA5]{2,})/g,"\uff0c").replace(/[ ](?=[\u4E00-\u9FA5])/g,"").replace(n,"");return 0<a.length&&b?configs.Divide+a:a};b=function(a,b){return a.fmtReg(f,"gim",b)};a=a.replaceBorder(f.t0).replace(b("^{$f}({$t0})({$s}|$)$"),function(a,b){return b.setAlign(e,g,c)}).replaceBorder(f.t1.join("|")).replace(b("^{$f}({$t1})(?:{$sn})({$e}|$)$","|"),function(a,
b,d){return a.match(/[\u3002]/g)||d.match(/^[\uff01\uff1f\u3002]{1,3}$/g)||a.match(configs.regSkipTitle.t1)?a:(b+h(d)).setAlign(e,g,c)}).replaceBorder(f.t2).replace(b("^{$f}{$t2}({$sn})({$e}|$)$"),function(a,b,f,k){return a.match(/[\u3002]/g)||b.match(/^[\-\u2014]{2,4}/g)||!d&&k.match(/^[\uff01\uff1f\u3002\u2026]{1,3}$/g)||!f.match(l)&&(!d&&k.match(/[\uff0c]|[\uff01\uff1f\u3002\u2026\u2019\u201d\u300f\u300d]{1,3}$/g)||a.match(configs.regSkipTitle.t2))?a:("\u7b2c"+b.replace(/(^[\u7b2c]+| )/g,"")+h(k)).setAlign(e,
g,c)}).replaceBorder(f.t5).replace(b("^{$f}{$t5}({$e}|$)$"),function(a,b,d){return a.match(/[\u3002]/g)?a:(b+h(d,"no")).setAlign(e,g,c)});if("center"===c||"break"===c)return a;var m=configs.regSkipTitle.t4;return a.replaceBorder(f.t3).replace(b("^{$f}{$t3}(?:{$sn})({$e}|$)$"),function(a,b,c,d){return e+"\u7b2c"+c+b+h(d)+g}).replaceBorder(f.t6).replace(b("^{$f}{$t6}(?:{$s})({$e}|$)$"),function(a,b,c){return e+"\u7b2c"+b+"\u7ae0"+h(c)+g}).replaceBorder(f.t4).replace(b("^{$f}{$t4}({$s}|{$s}{$e}|$)$"),
function(a,b,c){if(a.match(/[\u3002]$/g)||c.match(/^[\uff01\uff1f\u3002]{1,3}$/gm))return a;if(b.match(/^[\d\uff10-\uff19]+/gm)){if(c.match(/[\uff01\uff1f\u3002]$/g))return a}else if(c.match(/[\uff01\uff1f\u3002\u2026\u2019\u201d\u300f\u300d]$/g))return a;for(var d=0;d<m.length;d++)if(a.match(m[d]))return a;return e+"\u7b2c"+b+"\u7ae0"+h(c)+g})},replaceTitleError:function(){var a=this,b=function(a){return a.fmtReg(regChapterCut,"gm")},c=b("(^[{$space}]*(\u7b2c[0-9]{1,9}[{$c.2}])(\uff1a.{0,40}|$)$\\n+){2,}");
if(a.match(c)){var d=b("^\u7b2c([0-9]{1,9})[{$c.2}]\uff1a");var e=b("^\u7b2c([0-9]{1,9})[{$c.2}]$");a=a.replace(c,function(a){return a.replace(d,"$1\u3001").replace(e,"$1").replace(/\n\n+/gm,"\n")}).replace(/\n\n([0-9]{1,9}\u3001?)/g,"$1")}c=b("(^[{$space}]*(\u7b2c{$n.3}{1,9}[{$c.2}])(\uff1a.{0,40}|$)$\\n+){2,}");a.match(c)&&(d=b("^\u7b2c({$n.3}{1,9})[{$c.2}]\uff1a"),e=b("^\u7b2c({$n.3}{1,9})[{$c.2}]$"),a=a.replace(c,function(a){return a.replace(d,"$1\u3001").replace(e,"$1").replace(/\n\n+/gm,"\n")}).replace(b("\\n\\n({$n.3}{1,9}\u3001?)"),

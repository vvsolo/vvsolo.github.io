...
"\u3010\u6ce8$1\u3011").replace(/([^\d\.])(\d{1,2}\/\d{1,2})$/,"$1\uff08$2\uff09").replace(/([^\d\.]) ?\b(\d{1,2})$/,"$1\uff08$2\uff09").replace(/ ?\b([IVXC]{1,6})\b$/i,function(a){return"\uff08"+a.toUpperCase()+"\uff09"});return 0<a.length&&h?configs.Divide+a:a},n=function(a){return isNaN(a)?a:2>String(a).length?"0"+a:a},k=function(a,h){return configs.regSkipTitle[h||"t0"].test(a)};a=this.cleanSpace("^{$ts}".chapReg()).__Chapter(c.t0,"^{$f}({$t0})(?:{$s}|$)$","",function(a,h){return h.setAlign(e,
f,d)}).__Chapter(c.t1.join("|"),"^{$f}({$t1})({$s}{$e}|{$sn}$)$","|",function(a,h,b){return k(a)||/^[!\?\uff01\uff1f\u3002]{1,3}$/.test(b)||k(a,"t1")?a:(h+l(b)).setAlign(e,f,d)}).__Chapter(c.t2,"^{$f}{$t2}({$sn})({$e}|$)$","",function(a,b,c,m){if(k(a)||/^[\-\u2014]{2,4}/.test(b)||!g&&/^[\uff01\uff1f\u3002\u2026]{1,3}$/.test(m)||!c&&(!g&&/[\uff0c]|[\uff01\uff1f\u3002\u2026\u2019\u201d\u300f\u300d]{1,3}$/.test(m)||k(a,"t2")))return a;"{$n4}[{$c}]".fmtReg(strChapter).test(b)||(b="\u7b2c"+b.replace(/(^\u7b2c+| )/g,
"").convertNumberLetter());b=n(b);return/^(\u5b8c|\u5b8c\u7ed3|\u5f85\u7eed)$/m.test(m)?"\u3010"+b+"\u00b7"+m+"\u3011":(b+l(m)).setAlign(e,f,d)}).__Chapter(c.t3,"^{$f}{$t3}({$e}|$)$","",function(a,b,c){if(k(a))return a;b=n(b.convertNumberLetter());return(b+l(c,"no")).setAlign(e,f,d)});if("center"===d||"break"===d)return a;var p=configs.regSkipTitle.t6;return a.__Chapter(c.t4,"^{$f}{$t4}{$sn}({$e}|$)$","",function(a,b,c,d){return(e+"\u7b2c"+c+b+l(d)+f).convertNumberLetter()}).__Chapter(c.t5,"^{$f}{$t5}{$s}({$e}|$)$",
"",function(a,b,c){return(e+"\u7b2c"+b+"\u7ae0"+l(c)+f).convertNumberLetter()}).__Chapter(c.t6,"^{$f}{$t6}({$s}|{$s}{$e}|$)$","",function(a,b,c){if(k(a)||k(a,"t2")||/^[\uff01\uff1f\u3002]{1,3}$/.test(c)||/[\u3002]/.test(a))return a;if(/^[\d\uff10-\uff19]+/.test(b)){if(/[\uff01\uff1f\u3002]$/.test(c))return a}else if(/[\uff01\uff1f\u3002\u2026\u2019\u201d\u300f\u300d]$/.test(c))return a;if(a.cleanSpace().eachRegTest(p))return a;b=n(b);return(e+"\u7b2c"+b+"\u7ae0"+l(c)+f).convertNumberLetter()})},replaceTitleError:function(){var a=
function(a){return[["^{$f}\u7b2c({$zz})[{$c.2}]\uff1a".fmt(a).chapReg(),"$1\u3001"],["^{$f}\u7b2c({$zz})[{$c.2}]$".fmt(a).chapReg(),"$1"],["^{$f}({$zz})[\uff1a\u3001\u3002.,]".fmt(a).chapReg(),"$1\u3001"]]},b="(^{$f}\u7b2c{$n1}[{$c.2}](?:[\uff1a].{0,40}|$)$\\n+|^{$f}{$n1}(?:[\uff1a\u3001\u3002\\.\\,].{0,40}|$)$\\n+){2,}".chapReg(),d="(^{$f}(\u7b2c{$n3}[{$c.2}])(?:[\uff1a].{0,40}|$)$\\n+|^{$f}{$n3}(?:[\uff1a\u3001\u3002\\.\\,].{0,40}|$)$\\n+){2,}".chapReg(),g="(\\n+^{$f}\uff08(?:{$n2}|{$n3})\uff09(?:.{0,40}|$)$\\n+){2,}".chapReg(),
e="(^{$f}(?:{$n1}|{$n3})(?:[\uff1a\u3001\u3002\\.\\,].{0,40}|$)$\\n+)\\1".chapReg("gm"),f="(^{$f}\uff08(?:{$n2}|{$n3})\uff09(?:.{0,40}|$)$\\n+)\\1".chapReg("gm");return this.replace(b,function(b){return b.replaces(a("{$n1}")).replace(/^0{1,4}/gm,"").replace(/\n\n+/gm,"\n")}).replace(d,function(b){return b.replaces(a("{$n3}")).replace(/\n\n+/gm,"\n")}).replace("\\n\\n((?:{$n1}|{$n3})\u3001?)".chapReg(),"$1").replace(g,function(a){return a.replace(/\n\n*/gm,"\n")}).replace(e,function(a,b){return b.replaceTitle("\n\n",

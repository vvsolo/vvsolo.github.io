...
"$1"+a[2]).replace(/"/g,a[3]).replace(new RegExp("^([\u3000]*)"+a[3],"gm"),"$1"+a[2]).replace(new RegExp(a[2]+"$","gm"),a[3]).replace(new RegExp("\uff1a"+a[3],"g"),"\uff1a"+a[2])},toTitleCenter:function(a,d,b){a=a||"\n";d=d||"";b=b||!1;var g=2*configs.Linenum,h=this.trimSpace();if(b){var e=h.len(),k=0===e%4?" ":"";b&&g>e&&(h="\u3000".times(parseInt((g-e)/4,10))+k+h)}return a+h+d},replaceTitle:function(a,d,b,g){var h=configs.Divide,e=a||"\n\n",k=d||"",m=b||!1;a=this;g&&(configs.regSeparator=configs.regSeparatorNull,
configs.regStrictEnd=configs.regEnd);var l=configs.regTitle;g=configs.regSeparator;var q=configs.regSeparatorNull,r=new RegExp("^"+g,"g"),u=new RegExp("^"+g+"$","g"),p=configs.regTitleBorder;m&&(a=a.replace(new RegExp(configs.regStart+configs.Separator,"gm"),function(a){return a.toTitleCenter("","",m)}));d=function(a,b){b=b||l.t2;return a.replace(new RegExp([p[0]+"?("+b+")"+p[1]+"?","("+q+")",p[0]+"?"+configs.regEnd+p[1]+"?"].join(""),"gm"),function(a){return a.replace(new RegExp("["+p.join("")+"]",
"g"),"")})};var n=function(a,b){if(0==a.length)return"";b=b?!1:!0;a=a.replace(/[ ]{1,}/g," ").replace(r,"").replace(/([\u4E00-\u9FA5]{2,})[ ]([\u4E00-\u9FA5]{2,})/g,"$1\uff0c$2").replace(/([\u4E00-\u9FA5])[ ]([\u4E00-\u9FA5])/g,"$1$2").replace(/(\w+)[ ]{1,4}(\w+)/g,"$1 $2").replace(u,"");return 0<a.length&&b?h+a:a};b=["^"+configs.regStart,"","(?:"+q+")","("+configs.regEnd+"|$)","$"];b[1]="("+l.t1.join("|")+")";a=d(a,b[1]);a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d){if(d.match(/^[\uff01\uff1f\u3002]{1,3}$/g))return a;
d=n(d);return(b+d).toTitleCenter(e,k,m)});b[1]=l.t2;a=d(a,b[1]);b[2]="("+q+")";a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d,f){if(d.match(/^[\-\u2014]{1,4}/g)||f.match(/^[\uff01\uff1f\u3002\u2026]{1,3}$/g)||!d.match(r)&&f.match(/[\uff0c]|[\uff01\uff1f\u3002\u2026]{1,3}$/g)||a.match(configs.regSkipTitle)&&!d.match(r)&&f.match(/[\uff01\uff1f\u3002\u2026]{1,3}$/g))return a;f=n(f);b=b.replace(/(^[\u7b2c]+| )/g,"");return("\u7b2c"+b+f).toTitleCenter(e,k,m)});b[1]=l.t5;b[2]="";a=d(a,b[1]);a=a.replace(new RegExp(b.join(""),
"gm"),function(a,b,d){d=n(d,"no");return(b+d).toTitleCenter(e,k,m)});if(m)return a;b[1]=l.t3;b[2]="(?:"+q+")";a=d(a,b[1]);a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d,f){f=n(f);return e+"\u7b2c"+d+b+f+k});b[1]=l.t6;a=d(a,b[1]);a=a.replace(new RegExp(b.join(""),"gim"),function(a,b,d){d=n(d);return e+"\u7b2c"+b+"\u7ae0"+d+k});b[1]=l.t4;b[2]="("+g+"|";b[3]=g+configs.regStrictEnd+"|$)";var t=configs.regSkipTitle1;return a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d){if(d.match(/^[\uff01\uff1f\u3002\u2026]{1,3}$/g)||
!d.match(r)&&d.match(/[\uff01\uff1f\u3002\u2026]$/g))return a;for(var f=0;f<t.length;f++)if(a.match(t[f]))return a;d=n(d);return e+"\u7b2c"+b+"\u7ae0"+d+k})}});

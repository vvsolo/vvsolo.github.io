...
"$1"+a[2]).replace(/"/g,a[3]).replace(new RegExp("^([\u3000]*)"+a[3],"gm"),"$1"+a[2]).replace(new RegExp(a[2]+"$","gm"),a[3]).replace(new RegExp("\uff1a"+a[3],"g"),"\uff1a"+a[2])},toTitleCenter:function(a,d,b){a=a||"\n";d=d||"";b=b||!1;var f=2*configs.Linenum,h=this.trim();if(b){var g=h.len();b&&f>g&&(h="\u3000".times(parseInt((f-g)/4,10))+h)}return a+h+d},replaceTitle:function(a,d,b,f){var h=configs.Divide,g=a||"\n\n",m=d||"",k=b||!1;a=this;f&&(configs.regSeparator=configs.regSeparatorNull,configs.regStrictEnd=
configs.regEnd);var l=configs.regTitle;f=configs.regSeparator;var q=configs.regSeparatorNull,r=new RegExp("^"+f,"g"),u=new RegExp("^"+f+"$","g"),n=configs.regTitleBorder;k&&(a=a.replace(new RegExp(configs.regStart+configs.Separator,"gm"),function(a){return a.toTitleCenter("","",k)}));d=function(a,b){b=b||l.t2;return a.replace(new RegExp([n[0]+"?("+b+")"+n[1]+"?","("+q+")",n[0]+"?"+configs.regEnd+n[1]+"?"].join(""),"gm"),function(a){return a.replace(new RegExp("["+n.join("")+"]","g"),"")})};var p=
function(a,b){if(0==a.length)return"";b=b?!1:!0;a=a.replace(/[ ]{1,}/g," ").replace(r,"").replace(/([\u4E00-\u9FA5]{2,})[ ]([\u4E00-\u9FA5]{2,})/g,"$1\uff0c$2").replace(/([\u4E00-\u9FA5])[ ]([\u4E00-\u9FA5])/g,"$1$2").replace(/(\w+)[ ]{1,4}(\w+)/g,"$1 $2").replace(u,"");return 0<a.length&&b?h+a:a};b=["^"+configs.regStart,"","(?:"+q+")","("+configs.regEnd+"|$)","$"];b[1]="("+l.t1.join("|")+")";a=d(a,b[1]);a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d){if(d.match(/^[\uff01\uff1f\u3002]{1,3}$/g))return a;
d=p(d);return(b+d).toTitleCenter(g,m,k)});b[1]=l.t2;a=d(a,b[1]);b[2]="("+q+")";a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d,e){if(d.match(/^[\-\u2014]{1,4}/g)||e.match(/^[\uff01\uff1f\u3002\u2026]{1,3}$/g)||!d.match(r)&&e.match(/[\uff0c]|[\uff01\uff1f\u3002\u2026]{1,3}$/g)||a.match(configs.regSkipTitle)&&!d.match(r)&&e.match(/[\uff01\uff1f\u3002\u2026]{1,3}$/g))return a;e=p(e);b=b.replace(/(^[\u7b2c]+| )/g,"");return("\u7b2c"+b+e).toTitleCenter(g,m,k)});b[1]=l.t5;b[2]="";a=d(a,b[1]);a=a.replace(new RegExp(b.join(""),
"gm"),function(a,b,d){d=p(d,"no");return(b+d).toTitleCenter(g,m,k)});if(k)return a;b[1]=l.t3;b[2]="(?:"+q+")";a=d(a,b[1]);a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d,e){e=p(e);return g+"\u7b2c"+d+b+e+m});b[1]=l.t4;b[2]="("+f+"|";b[3]=f+configs.regStrictEnd+"|$)";var t=configs.regSkipTitle1;return a=a.replace(new RegExp(b.join(""),"gm"),function(a,b,d){if(d.match(/^[\uff01\uff1f\u3002\u2026]{1,3}$/g)||!d.match(r)&&d.match(/[\uff01\uff1f\u3002\u2026]$/g))return a;for(var e=0;e<t.length;e++)if(a.match(t[e]))return a;
d=p(d);return g+"\u7b2c"+b+"\u7ae0"+d+m})}});

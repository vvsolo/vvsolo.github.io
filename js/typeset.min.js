...
"\n$1"]];a=a.replaceInit().replaceSpace().replaceTitle(b[0],b[1]).replaceQuotes().replaces(c).replace(e,"");return editorCleanUp(a)}function setTitle(){var a=/^[\uff08\u3010\u201c\u300c<]|[\uff09\u3011\u201d\u300d>]$/g,b=$("#inputBookName").val(),e=$("#inputChapter").val(),c="";0<b.length&&(c="\u3010"+b.trim().replace(a,"")+"\u3011");0<e.length&&(c+="\uff08"+e.trim().replace(a,"")+"\uff09");$("#TitleMsg").html(c||$("#TitleMsg").attr("data-tip"))};

...
function doSplit(a,b,c){if(0===a.trim().len()||/^\u3000{2,}/gm.test(a)||a==="\uff0a".times(35))return a+c;var f="",e="\u3000\u3000"+a.trim(),g=g||2*configs.Linenum;if(g>e.len())return e+c;a=Math.floor(e.len()/g)+1;for(c=0;c<a;c++){var d=e.realSubstring(0,g).replace(/([\u300c\u201c\u300a\u300e\u2018\uff08]){1,2}$/gm,function(a){e+=a;return""});e=e.realSubstring(d.len()).replace(/^[\uff0c\u3002\uff1a\u3001\uff1b\uff1a\uff1f\uff01\uff0e\uff09\u300b\u300d\u300f]{1,2}/gm,function(a){d+=a;return""}).replace(/^[\u2026\uff5e\uff0d]$/gm,
function(a){d+=a;return""});var h=0<d.replace(tmpRegs[0],"").length;if(d.len()<g&&h){var k=tmpRegs[1].test(d)?tmpRegs[1]:tmpRegs[2];d=d.replace(k,"$1 $2").replace(/[\u201c\u2018\u300e\u300c] .*[\u300d\u300f\u2019\u201d]/i,function(a){return a.replace(/([\u201c\u2018\u300e\u300c]) /g,"$1").replace(/ (?=[\u300d\u300f\u2019\u201d])/g,"")+" "});d.len()<g&&h&&(d=d.replace(/ ?([0-9a-z]) ?/i,"$1").replace(/ (?=[\u201c\u2018\u300e\u300c])/g,"").replace(/([\u300d\u300f\u2019\u201d]) /g,"$1"))}f+=d+"\n"}return f+
b}

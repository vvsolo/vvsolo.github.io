...
function doTidy(a){var f=new RegExp("^[ \u3000]*([\uff08\u3010\u201c\u300c<]?)("+configs.endStrs+")([\uff09\u3011\u201d\u300d>]?)$","gm");a=a.replaceInit().replaces([[/\u201c/g,"\u300c"],[/\u201d/g,"\u300d"],[/\u2018/g,"\u300e"],[/\u2019/g,"\u300f"]]).convertNumberLetter().replaceSeparator();var c=a.split("\n"),d=c.length;a="";for(var g=0;g<d;g++)a+=doSplit(c[g].trim(),"\n","\n\n");a=a.replace(/\u4f5c\u8005\uff1a(.*)\n(.*)\u53d1\u8868\u4e8e\uff1a(.*)\n\u662f\u5426\u9996\u53d1\uff1a(.*)\n\u5b57\u6570\uff1a(.*)\n/gm,
"").replace(f,function(a){return a.toTitleCenter("","",!0)}).replaceTitle("","",!0).replace(/^([ \u3000]+)$\n/gm,"").replace(/\n{3,}$/gm,"\n\n").replace(/^\n{2,}/gm,"\n");a="\n"+a;f=a.length;c=a.findCount(configs.AllSpace);f={writer:$("#inputAuthor").val().trim(),bbsname:$("#inputSite").val().trim(),dateStr:(new Date).format("yyyy/MM/dd"),strNum:cc(f-c)};return("zh-CN"==$("html").attr("lang")?"\u4f5c\u8005\uff1a{writer}\n{dateStr}\u53d1\u8868\u4e8e\uff1a{bbsname}\n\u662f\u5426\u9996\u53d1\uff1a\u662f\n\u5b57\u6570\uff1a{strNum} \u5b57\n":
"\u4f5c\u8005\uff1a{writer}\n{dateStr}\u767c\u8868\u65bc\uff1a{bbsname}\n\u662f\u5426\u9996\u767c\uff1a\u662f\n\u5b57\u6578\uff1a{strNum} \u5b57\n").format(f)+a}
function getCleanUp(a){a=a.replaceInit();$("#Check_0").is(":checked")&&(a=a.converHtmlEntity());$("#Check_1").is(":checked")&&(a=a.converUnicode());$("#Check_2").is(":checked")&&(a=a.convertVariant());$("#Check_3").is(":checked")&&(a=a.convertSerialNumber());$("#Check_4").is(":checked")&&(a=a.convertNumberLetter());$("#Check_5").is(":checked")&&(a=a.convertPunctuation());$("#Check_6").is(":checked")&&(a=a.replaceTitle());$("#Check_7").is(":checked")&&(a=a.replaceSpace());$("#Check_8").is(":checked")&&

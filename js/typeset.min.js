function doSplit(a,c,d){if(0===a.trim().len())return a;if(/^\u3000{2,}/gm.test(a)||a==="\uff0a".times(35))return a+"\n\n";var f=2*configs.Linenum,g="",h="",e="\u3000\u3000"+a;if(e.len()>f){a=Math.floor(e.len()/f)+1;for(d=0;d<a;d++){var b=e.realSubstring(0,f);b=b.replace(/([\u300c\u201c\u300a\u300e\u2018\uff08]){1,2}$/gm,function(a){e+=a;return""});e=e.realSubstring(b.len());e=e.replace(/^([\uff0c\u3002\uff1a\u3001\uff1b\uff1a\uff1f\uff01\uff0e\uff09\u300b\u300d\u300f]{1,2})/gm,function(a){b+=a;return""});
e=e.replace(/^([\u2026\uff5e\uff0d])$/gm,function(a){b+=a;return""});var k=0===b.replace(/[\w]/g,"").space().replace(configs.HWPunctuation,"").replace(configs.FWPunctuation,"").length;b.len()<f&&!k&&(b=b.match(/([\u4e00-\u9fa0\uff01\uff08\uff09\uff0c\uff0e\uff1a\uff1b\uff1f\u2018\u2019\u201c\u201d\u3002\u300e\u300f\u300c\u300d])([0-9a-zA-Z])/)?b.replace(/([\u4e00-\u9fa0\uff01\uff08\uff09\uff0c\uff0e\uff1a\uff1b\uff1f\u2018\u2019\u201c\u201d\u3002\u300e\u300f\u300c\u300d])([0-9a-zA-Z])/,"$1 $2"):b.replace(/([0-9a-zA-Z])([\u4e00-\u9fa0\uff01\uff08\uff09\uff0c\uff0e\uff1a\uff1b\uff1f\u2018\u2019\u201c\u201d\u3002\u300e\u300f\u300c\u300d])/,
"$1 $2"),b=b.replace(/([\u201c\u2018\u300e\u300c][0-9a-zA-Z ]+[\u300d\u300f\u2019\u201d])/g,function(a){return a.replace(/ /g,"")+" "}));h+=b+"\n"}g+=h+c}else g+=e+d;return g}
function doTidy(a){var c=new RegExp("^[ \u3000]*([\uff08\u3010\u201c\u300c<]?)("+configs.endStrs+")([\uff09\u3011\u201d\u300d>]?)$","gm");a=a.replaceInit().replaces([[/\u201c/g,"\u300c"],[/\u201d/g,"\u300d"],[/\u2018/g,"\u300e"],[/\u2019/g,"\u300f"],[/\u4f5c\u8005\uff1a(.*?)\n([\d\/]*)(\u53d1\u8868\u4e8e|\u767c\u8868\u65bc)\uff1a(.*?)\n\u662f\u5426(\u9996\u53d1|\u9996\u767c)\uff1a(.*?)\n\u5b57[\u6570\u6578]\uff1a(.*?)\n/gm,""]]).convertNumberLetter().replaceSeparator().replace(c,function(a){return a.setAlign("",
"","center")}).replace(configs.novelTitle,function(a){return a.setAlign("","","center")}).replace(configs.Separator.getReg("gm"),function(a){return a.setAlign("","","center")}).replaceTitle("\n","\n","center");c=a.split("\n");a="";for(var d=0;d<c.length;d++)a+=doSplit(c[d],"\n","\n\n");a=a.replace(/^([ \u3000]+)$\n/gm,"").replace(/\n{3,}$/gm,"\n\n").replace(/^\n{2,}/gm,"\n");c="\u7b80"!==$("#chinese").html()?"\u4f5c\u8005\uff1a{$w}\n{$d}\u53d1\u8868\u4e8e\uff1a{$b}\n\u662f\u5426\u9996\u53d1\uff1a{$y}\n\u5b57\u6570\uff1a{$n} \u5b57\n":

...
function doSplit(a,b,c){if(0===a.trim().len()||/^\u3000{2,}/gm.test(a)||a==="\uff0a".times(35))return a+c;var h="",e="\u3000\u3000"+a.trim();a=0;var f=f||2*configs.Linenum;if(f>e.len())return e+c;for(c=Math.floor(e.len()/f)+1;a<c;a++){var d=e.realSubstring(0,f);d=d.replace(/([\u300c\u201c\u300a\u300e\u2018\uff08]){1,2}$/gm,function(a){e+=a;return""});e=e.realSubstring(d.len()).replace(/^([\uff0c\u3002\uff1a\u3001\uff1b\uff1a\uff1f\uff01\uff0e\uff09\u300b\u300d\u300f]{1,2})/gm,function(a){d+=a;return""}).replace(/^([\u2026\uff5e\uff0d])$/gm,
function(a){d+=a;return""});var g=0<d.replace(tmpRegs[0],"").length;d.len()<f&&g&&(g=tmpRegs[1].test(d)?tmpRegs[1]:tmpRegs[2],d=d.replace(g,"$1 $2").replace(/([\u201c\u2018\u300e\u300c][0-9a-z ]+[\u300d\u300f\u2019\u201d])/i,function(a){return a.replace(/ /g,"")+" "}));h+=d+"\n"}return h+b}
...
function setTitle(){var a=$("#inputBookName").val(),b=$("#inputChapter").val(),c="";0<a.length&&(c="\u3010"+a.trim().replace(/(^[\uff08\u3010\u201c\u300c<]|[\uff09\u3011\u201d\u300d>]$)/g,"")+"\u3011");0<b.length&&(c+="\uff08"+b.trim().replace(/(^[\uff08\u3010\u201c\u300c<]|[\uff09\u3011\u201d\u300d>]$)/g,"")+"\uff09");$("#TitleMsg").html(c||$("#TitleMsg").attr("data-tip"))};

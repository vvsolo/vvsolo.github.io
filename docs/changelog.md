...
### 260701 更新日志
- 【OpenCC】更新为 1.4.0，ocd2 存储，速度提升（注：未使用分词插件）
- 【整理·分段】段落中某些不规则的空格，会造成无法清除临时占位字符
- 【快捷输入】修正一个大小写错误，并修改部分单字母设定
  - `j` 卷
  - `i` 集
  - `c` 册
  - `e` 节
  - `!sj` 上卷
  - `!si` 上集
- 【全局检查】修正单引号内全英文时的错误提示
- 【右键字词查询】修正 `国学大师` 网址
- 【网页版】修正因参数问题引起的引用和部分功能无法起效
- 【网页版】修正多次排版文本不转换直角引用的错误

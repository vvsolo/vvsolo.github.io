...
### 230201 更新日志
- 优化：【网页版】调整界面元素、调整编辑框默认字体为 `思源宋体, 宋体`、调整快捷键设置防止冲突、小尺寸窗口隐藏某些元素；移动端访问优化中；
- 修正：【章节标题】某些英文章节的转换错误
- 优化：【词组混淆】合并省市的混淆处理
- 优化：【correct.txt】`到` -> `道` 修正
- 优化：【小说脚注】添加脚注样式
- 优化：【章节标题】添加非常规的标题样式
- 优化：【章节标题】小标号正则匹配
- 优化：【章节转数字】补全数字位数的处理
- 优化：【全局整理】某些以句号结尾的章节标题
- 优化：【特殊整理】某些以句号结尾的章节标题
- 优化：【着色文件】对应新正则改写
- 优化：【核心代码】为 Node.js 版本和网页版本预留代码
- 优化：【核心代码】规范函数名称
- 优化：英文格式、标点符号、分隔符号、结尾处理的正则优化
- 更新：OpenCC 1.1.6
